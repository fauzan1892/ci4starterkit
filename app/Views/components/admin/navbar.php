    ...
    <ul class="app-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                ...
                <li><a class="dropdown-item" href="<?= base_url('admin/users/profil');?>">
                <i class="fa fa-user-circle fa-lg"></i> Profile</a></li>
                <div class="dropdown-divider"></div>
                <li>
                    <a class="dropdown-item" href="<?= base_url('login/logout');?>"><i class="fa fa-sign-out fa-lg"></i> Logout</a>
                </li>
            </ul>
        </li>
    </ul>
